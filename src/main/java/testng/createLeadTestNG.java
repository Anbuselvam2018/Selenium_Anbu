...
import wd.Annotations2;

public class createLeadTestNG extends Annotations2{
	//@Test (priority=1)
	@Test(groups= {"Sanity"})
	public void CreateLeadTest() throws InterruptedException{
		...
		type(eleComplanyName,"SevenStar");

		WebElement eleFirstName = locateElement("id", "createLeadForm_firstName");
		type(eleFirstName,"Kamalesh");

		WebElement eleLastName = locateElement("id", "createLeadForm_lastName");
		type(eleLastName,"Modi");
